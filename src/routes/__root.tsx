  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Ops! Parece que essa página saiu do cardápio.</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          Não conseguimos encontrar o que você estava procurando.
          <br>
          </br>
          Mas não se preocupe, ainda podemos ajudar você a encontrar uma alimentação que faça sentido para a sua rotina.
        </p>
        <div className="mt-6">
          <Link
            to="/"
